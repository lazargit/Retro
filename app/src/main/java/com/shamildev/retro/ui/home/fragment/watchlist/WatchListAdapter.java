...
public class WatchListAdapter extends RecyclerView.Adapter {
    ...
    public WatchListAdapter(List<MediaItem> watchList, Context context, RetroImage retroImage, WatchListFragment fragment) {
    ...
    private void loadImage(MediaItem item, ViewHolder viewHolder){
        ...
        this.retroImage
                    .load(item)
                   .Poster().w780().into(viewHolder.imageView, new RetroImageRequestListener() {
                    @Override
...
//                            .into(imageView);
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private WatchListAdapter.ViewHolderListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final WatchListAdapter.ViewHolderListener clickListener) {
