...
import com.shamildev.retro.ui.mylist.adapter.MyListAdapter;
...
public class MyListFragment extends BaseViewFragmentV4<MyListPresenter> implements MyListView,RecyclerItemTouchHelper.RecyclerItemTouchHelperListener  {

    public static final String TAG = MyListFragment.class.getSimpleName();
    private Unbinder butterKnifeUnbinder;
    private MyListAdapter recyclerViewPagerAdapter;
...
//    ImageSliderView imgsliderHeader;
    ...
    private void setupRecyclerView(RecyclerView recyclerView, List<MediaItem> watchList) {
        ...
        recyclerViewPagerAdapter = new MyListAdapter(watchList, getContext(), retroImage, this);
