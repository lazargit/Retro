...
//      }
    ...
    //  MainActivity.currentPosition = position;
      ...
      Log.e("SHARED",fragment.getClass().getName()+"  "+transitioningView.getTransitionName());

      Log.e("MANAGER","> "+fragment.getFragmentManager().getFragments());
      fragment.getFragmentManager()
          .beginTransaction()
          .setReorderingAllowed(true) // Optimize for shared element transition
          .addSharedElement(transitioningView, transitioningView.getTransitionName())
          .replace(R.id.fragmentContainer, new ImagePagerFragment(), ImagePagerFragment.class
              .getSimpleName())
          .addToBackStack(null)
          .commit();
    }
