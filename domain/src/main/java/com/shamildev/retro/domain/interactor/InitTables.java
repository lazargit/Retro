 ...
 */
public final class InitTables implements UseCaseFlowable<ParamsBasic, Configuration> {
    ...
    @Inject
    InitTables(RemoteRepository repository, CacheRepository cache, DataConfig dataConfig) {
